...
function createProvenanceDropdown() {
  ...
  const upstreamDocs  = "https://psutil.io/";
  const upstreamRepo  = "https://github.com/giampaolo/psutil";
  ...
  const mainContent = document.querySelector('div[class="article-column"]');
  if (mainContent) {
